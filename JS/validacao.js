function validar(){
    ...
    if(cidade.value == "" || cidade.value.length < 10){
    ...
    if(bairro.value == "" || bairro.value.length < 10){
    ...
    if(numero.value == "" || numero.value.length < 3){
    ...
    if(complemento.value == "" || complemento.value.length < 10){
        alert("Campo complemento é obrigatório!");
        complemento.style.backgroundColor = '#ffafaf';
        complemento.focus();
        return false;
    }
    else{
        complemento.style.backgroundColor = 'white';
    }
    ...
    if(telefone.value == "" || telefone.value.length < 10){
        ...
        telefone.style.backgroundColor = '#ffafaf';
        telefone.focus();
        return false;
    }
    else{
